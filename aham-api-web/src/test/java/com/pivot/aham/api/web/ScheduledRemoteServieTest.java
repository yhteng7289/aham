...
public class ScheduledRemoteServieTest {
    ...
    public void updateTask() {
        ...
        taskSchedule.setTaskGroup("DAS");
        taskSchedule.setTaskName("getAllValidRecommend");
        taskSchedule.setContactEmail("wooitatt.khor@ezyit.asia");
        taskSchedule.setContactName("jinling.cui");
        taskSchedule.setJobType(TaskScheduled.JobType.job);
        taskSchedule.setTaskType(TaskScheduled.TaskType.local);
        taskSchedule.setTargetMethod("getAllValidRecommend");
        taskSchedule.setTargetObject("modelServiceRemoteService");
        taskSchedule.setTaskCron("0 0 09 * * ?");
        taskSchedule.setTaskDesc("任务测试");
        taskSchedule.setTimeZone(TaskScheduled.TimeZoneType.america);
//        schedulerRemoteService.updateTask(taskSchedule);
    }
