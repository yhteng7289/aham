...
@Slf4j
public class PivotErrorFeeDetailRemoteServiceImpl implements PivotErrorDetailRemoteService {

    private final static String CONTACT_Email = PropertiesUtil.getString("pivot.error.alert.email");
