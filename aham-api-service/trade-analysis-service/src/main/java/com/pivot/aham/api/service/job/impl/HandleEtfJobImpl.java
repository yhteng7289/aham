 ...
 */
@Slf4j
public class HandleEtfJobImpl implements Runnable {
    ...
    public HandleEtfJobImpl(List<UserAssetPO> userAssetPOs, Date date, UserEtfSharesService userEtfSharesService, UserEtfSharesStaticService userEtfSharesStaticService) {
