...
@Data
public class SaxoAccountFundingEventPO {
    private Long id;
    ...
    public static SaxoAccountFundingEventPO convert(AccountFundingResp resp){
        try {
            SaxoAccountFundingEventPO eventPO = new SaxoAccountFundingEventPO();
