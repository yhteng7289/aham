...
/*@ElasticJobConf(name = "Trade4_SaxoShareTradesExecutedJob_2",
        shardingItemParameters = "0=1",
        shardingTotalCount = 1,
        cron = "0 0 15 * * ?", description = "交易订单对账")
@Slf4j
public class Trade4_SaxoShareTradesExecutedJob implements SimpleJob {
    @Autowired
    private SaxoStatisticService saxoStatisticService;

    @Override
    public void execute(ShardingContext shardingContext) {
        log.info("开始执行 =======>>> SaxoShareTradesExecutedJob");
        ...
        log.info("执行结束 =======>>> SaxoShareTradesExecutedJob");
    }
}*/
