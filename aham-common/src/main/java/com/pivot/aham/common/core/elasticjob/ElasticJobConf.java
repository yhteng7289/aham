...
public @interface ElasticJobConf {
     ...
     * 作业自定义参数
     * <p>
     * 作业自定义参数，可通过传递该参数为作业调度的业务方法传参，用于实现带参数的作业<p>
     * <p>
     ...
     * 是否流式处理数据
     * <p>
     * 如果流式处理数据, 则fetchData不返回空结果将持续执行作业<p>
     * <p>
     * 如果非流式处理数据, 则处理数据完成后作业结束<p>
     * @return
     */
     ...
     * @return
     */
    String jobExceptionHandler() default "MyElasticJobExceptionHandler";
