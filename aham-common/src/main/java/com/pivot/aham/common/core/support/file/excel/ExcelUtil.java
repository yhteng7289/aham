//package com.pivot.aham.common.core.support.file.excel;
//
//import Constants;
//import Message;
//import DateUtils;
...
//     * @return 结果
//     */
//    public Message exportExcel(List<T> list, String sheetName)
//    {
...
//                                {
//                                    cell.setCellValue(DateUtils.formatDate( (Date) field.get(vo),dateFormat));
//                                }
...
//            return Message.error("导出Excel失败，请联系网站管理员！");
//        }
//        finally
//        {
//            if (workbook != null)
...
//    {
//        String downloadPath = Constants.TMP_DOWNLOAD_PATH+"/"+ filename;
