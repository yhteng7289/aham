package com.pivot.aham.common.core;

import java.math.BigDecimal;
import java.util.Map;

import com.pivot.aham.common.core.support.cache.CacheKey;
...
public interface Constants {
    ...
    interface  MqConstants{
        String REFUND_MESSAGE_PREFIX = "bankRefund#";
        String REFUND_EXCHANGE = "rabbitmq.refund_exchange";
    }
