 ...
 */
package sg.com.aham.finance.utility.date;
...
import sg.com.aham.finance.utility.constant.Constants;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * "yyyy/MM", "yyyy.MM.dd", "yyyy.MM.dd HH:mm:ss", "yyyy.MM.dd HH:mm",
     * "yyyy.MM", "yyyyMMdd" , "yyyyMMddHH:mm:ss" }
     */
    ...
    /**
     * 按年月日获取日期 注: in calendar.set(xxx): month is base from 0, so must use
     * :natural_month - 1
     *
     * @param year
     * @param natural_month
